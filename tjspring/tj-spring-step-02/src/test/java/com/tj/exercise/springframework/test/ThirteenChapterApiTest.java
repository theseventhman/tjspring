...
public class ThirteenChapterApiTest {
    ...
    public void init(){
        //目标对象
        IUserService userService = new ThirteenChapterUserService();
        //组装代理信息
    ...
    public void test_advisor(){
        ...
        advisor.setExpression("execution(* com.tj.exercise.springframework.test.bean.IUserService.*(..))");
    ...
    public void test_aop() {
        ClassPathXmlApplicationContext applicationContext = new ClassPathXmlApplicationContext("classpath:ThirteenChapterSpring.xml");
    ...
    public void test_proxy_method(){
       // 目标对象(可以替换成任何的目标对象)
        Object targetObj = new ThirteenChapterUserService();
