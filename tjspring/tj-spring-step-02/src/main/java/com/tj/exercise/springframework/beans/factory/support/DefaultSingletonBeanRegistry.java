...
import com.tj.exercise.springframework.beans.factory.ObjectFactory;
...
public class DefaultSingletonBeanRegistry implements SingletonBeanRegistry {
     ...
     *  used as marker value ofr concurrent Maps (which don't support null values).
     */
    ...
    public Object getSingleton(String beanName) {
        ...
        if(null == singletonObject){
            ...
            // 判断二级缓存中是否有对象,如果一级和二级缓存中都没有这个对象，
            // 那么这个对象就是代理对象, 因为只有代理对象才会放到三级缓存中
            if(null == singletonObject){
    ...
    protected  void addSignleFactory(String beanName, ObjectFactory<?> singletonFactory){
